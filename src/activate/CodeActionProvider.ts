...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Operit Coder",
	FIX: "Fix with Operit Coder",
	IMPROVE: "Improve with Operit Coder",
	ADD_TO_CONTEXT: "Add to Operit Coder",
	NEW_TASK: "New Operit Coder Task",
} as const
